    ...
    <main className="min-h-screen flex items-center justify-center bg-zinc-950 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-zinc-800 bg-zinc-900 p-7">
          <h1 className="text-xl font-bold text-zinc-100 mb-1">Iniciar sesión</h1>
          <p className="text-sm text-zinc-500 mb-6">Acceso al equipo interno</p>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg bg-emerald-500 hover:bg-emerald-400 disabled:opacity-50 disabled:cursor-not-allowed text-zinc-950 text-sm font-semibold transition-colors"
            >
